      ...
      switch (CUP$Parser1$act_num)
		...
		RESULT = start_val;
          ...
          case 1: // INICIO ::= LISTA 
            {
              Nodo1 RESULT =null;
		int listleft = ((java_cup.runtime.Symbol)CUP$Parser1$stack.peek()).left;
		int listright = ((java_cup.runtime.Symbol)CUP$Parser1$stack.peek()).right;
		Nodo1 list = (Nodo1)((java_cup.runtime.Symbol) CUP$Parser1$stack.peek()).value;
          ...
          case 2: // LISTA ::= LISTA coma par 
            {
              Nodo1 RESULT =null;
		int listleft = ((java_cup.runtime.Symbol)CUP$Parser1$stack.elementAt(CUP$Parser1$top-2)).left;
		int listright = ((java_cup.runtime.Symbol)CUP$Parser1$stack.elementAt(CUP$Parser1$top-2)).right;
		Nodo1 list = (Nodo1)((java_cup.runtime.Symbol) CUP$Parser1$stack.elementAt(CUP$Parser1$top-2)).value;
